...
export class DetalleDeProductoComponent implements OnInit {
  ...
  constructor(private carritoService: CarritoService, public router: Router,  private productosService: ProductosService, private activatedRoute: ActivatedRoute, private dataSharingService: DataSharingService) {
  ...
  irCompra(){
    this.router.navigateByUrl('/terminar_compra')
  }
